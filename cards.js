...
const DEFAULT_CARDS = [
  {
    ...
    categories: [
      ...
      { key: 'other-travel', rate: 2, label: 'Other travel (airfare, hotel, rideshare, etc.)', keywords: ['flight', 'airfare', 'airline', 'hotel', 'motel', 'rideshare', 'uber ride', 'lyft', 'taxi', 'train', 'amtrak', 'parking', 'rental car', 'car rental', 'cruise', 'travel'] },
    ],
  ...
  },
  {
    ...
    categories: [
      ...
      { key: 'flight', rate: 3, label: 'Flights (direct or Amex Travel)', keywords: ['flight', 'airfare', 'airline', 'plane ticket'] },
  ...
  },
  {
    ...
    categories: [
      ...
      { key: 'flight-direct', rate: 7, label: 'Flights (direct with airline or AmexTravel.com)', keywords: ['flight', 'airfare', 'airline', 'plane ticket'] },
  ...
  },
  {
    ...
    categoryDefinitions: {
      ...
      'travel': { label: 'Travel', keywords: ['flight', 'airfare', 'hotel', 'rideshare', 'uber ride', 'lyft', 'taxi', 'train', 'parking', 'rental car', 'travel'] },
